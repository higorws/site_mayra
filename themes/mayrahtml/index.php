<section title="banner principal" class="banner_principal">
    ...
    <img class="Foto_banner"title="Sude mental e bem estar" alt="Saúde mental e bem estar" src="<?= INCLUDE_PATH; ?>/img/mãe_filha_banner.jpg">
...
<section title="Terapias" id="terapias">
    <div title="terapias" class="titulo_terapias">
        <div class="organizar_div2">
            <img title="terapias" alt="logo" src="<?= INCLUDE_PATH; ?>/img/logo2.png" width="40">
...
<script src="_cdn/main.js"></script> <!-- Resource jQuery -->
<section title="Publico atendido" id="publico_atendido">
    <div title="público atendido" class="titulo_publico">
        <div class="organizar_div3">
            <img title="" alt="logo" src="<?= INCLUDE_PATH; ?>/img/logo2.png" width="40">
    ...
    <div class="publico">
        <div class="infantil">
            <img alt="crianças" title="infantil" src="<?= INCLUDE_PATH; ?>/img/infantil.jpg">
            <h3>Infantil</h3>
        </div>
        <div class="adolescentes">
            <img alt="adolescentes" title="adolescentes" src="<?= INCLUDE_PATH; ?>/img/adolescentes.JPG">
            <h3>Adolescente</h3>
        </div>
        <div class="adultos">
            <img alt="Adultos" title="adultos" src="<?= INCLUDE_PATH; ?>/img/adultos .jpg">
            <h3>Adulto</h3>
        </div>
    </div>
</section>
<section title="Sobre a Mayra Silva" id="sobre_mim">
    ...
    <div title="um pouco mais sobre Mayra silva" class="sobre_mayra">
        <figure class="foto_maira">
            <img src="<?= INCLUDE_PATH; ?>/img/foto da maira.jpg" class="maira_img"alt="foto da maira"/>
